...
export const translations = {
  EN: {
    ...
    location: {
      ...
      titleAccent: 'Office',
      address: 'Address',
      addressVal: 'Tashkent, Kichik xalqa yoli 20',
      phone: 'Phone',
      hours: 'Working Hours',
  ...
  RU: {
    ...
    location: {
      ...
      titleAccent: 'офис',
      address: 'Адрес',
      addressVal: 'Ташкент, Малая кольцевая дорога 20',
      phone: 'Телефон',
      hours: 'Рабочие часы',
  ...
  UZ: {
    ...
    hero: {
      badge: 'Hashamatli sayohat tajribasi',
      title: 'Chegarasiz',
      titleAccent: 'sayohat qiling',
      subtext: 'Mehmonxonalar | Aviachiptalar | Vizalar | Transferlar',
      subtext2: 'GTS premium xizmati bilan dunyoni kashf eting.',
    ...
    location: {
      ...
      address: 'Manzil',
      addressVal: 'Toshkent, Kichik xalqa yo\'li 20',
      phone: 'Telefon',
      hours: 'Ish vaqti',
